...
while user_input != ("left" or "right"):
    ...
    if user_input == "left":
        ...
        while user_input != ("fight" or "back"):
            user_input = input()
            if user_input == "fight":
                ...
                while user_input != ("continue" or "run"):
                    user_input = input()
                    if user_input == "continue":
                        ...
                        while user_input != ("left" or "right"):
                            ...
                            if user_input == "left":
                                ...
                                while user_input != ("attempt" or "back"):
                                    user_input = input()
                                    ...
                                    if user_input == "attempt":
                                        ...
                                        while user_input != ("left" or "right"):
                                            ...
                                            if user_input == "left":
                                                ...
                                                while user_input != ("go in" or "return"):
                                                    user_input = input()
                                                    if user_input == "go in":
        ...
        while user_input != ("back" or "lion") and dead != False:
            user_input = input()
            if user_input == "back":
                ...
                user_input = 0
                while user_input != ("scale" or "back"):
                    user_input = input()
                    if user_input == "scale":
