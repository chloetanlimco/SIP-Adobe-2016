...
ball_size = random.randint(20,100)
x_location = 350
y_location = 250

x_speed2 = random.randint(-10,10)
y_speed2 = random.randint(-10,10)
ball_size2 = random.randint(20,100)
x_location2 = random.randint(100,600)
y_location2 = random.randint(100,400)
...
Ball1 = BouncingBall(x_location, y_location, x_speed, y_speed, ball_size)
Ball2 = BouncingBall(x_location2, y_location2, x_speed2, y_speed2, ball_size2)
